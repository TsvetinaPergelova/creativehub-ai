        ...
        <>
            ...
            <div className="space-y-6">
                <ProjectSection className="space-y-5">
                    ...
                    <ProjectInsetPanel className="mx-auto w-full max-w-2xl space-y-6 border-primary/18 shadow-none">
                        <Form
                ...
                {canManageTwoFactor ? (
                    <ProjectSection className="space-y-5">
                        ...
                        <ProjectInsetPanel className="mx-auto w-full max-w-2xl space-y-4 border-primary/18 shadow-none">
                            {twoFactorEnabled ? (
